...
public class OptionProcessingException extends RuntimeException {

	OptionProcessingException(String message) {
		super(message);
	}

	OptionProcessingException(String message, Throwable cause) {
		super(message, cause);
	}
}
